...
public class sortNotes : MonoBehaviour
{
        ...
        if (row1.Count > 1)
        {
            ...
            for (int i = 0; i < row1.Count; i++)
            {
                ...
                if (row1[i].transform.position.z < min)
                {
                    ...
                    //row1[i].GetComponent<NoteBehaviour>().isTheLowest = true;
                    minIndex = i;
                }
                if (row1[i].transform.position.z > max)
                {
                    max = row1[i].transform.position.z;
                    row1[i].GetComponent<NoteBehaviour>().isTheLowest = false;
                }
            }
            ...
            row1[minIndex].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
        else if(row1.Count == 1)
        {
            row1[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
    ...
    void checkIfTheLowestRow2()
    {
        ...
        if (row2.Count > 1)
        {
            ...
            for (int i = 0; i < row2.Count - 1; i++)
            {
                ...
                {
                    row2[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = false;
                }
            }
            //Debug.Log("minimum: " + minimum);
            //Debug.Log("correct Index: " + correctIndex);

            row2[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
        else if (row2.Count == 1)
        {
            row2[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
    ...
    void checkIfTheLowestRow3()
    {
        ...
        if (row3.Count > 1)
        {
            ...
            for (int i = 0; i < row3.Count - 1; i++)
            {
                ...
                {
                    row3[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = false;
                }
            }
            //Debug.Log("minimum: " + minimum);
            //Debug.Log("correct Index: " + correctIndex);

            row3[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
        else if (row3.Count == 1)
        {
            row3[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
    ...
    void checkIfTheLowestRow4()
    {
        ...
        if (row4.Count > 1)
        {
            ...
            for (int i = 0; i < row4.Count - 1; i++)
            {
                ...
                {
                    row4[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = false;
                }
            }
            //Debug.Log("minimum: " + minimum);
            //Debug.Log("correct Index: " + correctIndex);

            row4[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
        else if (row4.Count == 1)
        {
            row4[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
    ...
    void checkIfTheLowestRow5()
    {
        ...
        if (row5.Count > 1)
        {
            ...
            for (int i = 0; i < row5.Count - 1; i++)
            {
                ...
                {
                    row5[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = false;
                }
            }
            //Debug.Log("minimum: " + minimum);
            //Debug.Log("correct Index: " + correctIndex);

            row5[correctIndex].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
        else if (row5.Count == 1)
        {
            row5[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
    ...
    void checkIfTheLowestRow6()
    {
        ...
        {
            row6[0].GetComponent<NoteBehaviour>().isTheLowest = true;
        }
    }
